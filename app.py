...
swagger_template = dict(
    info = {
        'title': LazyString(lambda: 'API for cleansing data tweet'),
        'version': LazyString(lambda: '1.0.0'),
        'description': LazyString(lambda: 'Dokumentasi API untuk hasil olah data tweet yang mengandung beberapa kata Data cleansing')
    },
